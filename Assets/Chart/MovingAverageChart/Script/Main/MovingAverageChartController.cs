...
namespace MovingAverageChart
{
    public class MovingAverageChartController : MonoBehaviour
    {
        //private variable
        ...
        [Space] [SerializeField] private MovingAverageChart _candlestickChart;
        ...
        public void DrawChart(List<MovingAverageChart.ChartData> chartDatas) =>
